...
sakai_global.cccalendarfeed = function (tuid, showSettings) {
    ...
    onStateAvailable = function (succeeded, state) {
        ...
        _title = state.title;
        _feedUrl = state.url;
		console.log('1 _feedUrl = ' + _feedUrl);
...
console.log('2 _feedUrl = ' + _feedUrl);
...
console.log('3A state.url = ' + state.url);
console.log('3B url = ' + url);
        } else {
...
require(
    [
        ...
        "/devwidgets/cccalendarfeed/lib/ccdates.js",
        "/devwidgets/cccalendarfeed/lib/jquery.ui.slider.js"
    ],
    function (jquery, sakai, dates) {

        "use strict";

        sakai_global.cccalendarfeed.imports = {
            jquery : jquery,
            sakai : sakai,
            dates: dates
        };
